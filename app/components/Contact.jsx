...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "1484d536-492f-41f6-89fb-e57cc0b5a4d9");
  ...
  return (
    ...
    bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none'>
      ...
      className='text-center mb-2 text-lg fornt-Ovo'>
      ...
      className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
        I'd love to hear from you! If you have any questions, comments, or feedback please
         use the form below
      </motion.p>
      ...
      onSubmit={onSubmit} className='max-w-2xl mx-auto'>
        <div className='grid grid-cols-auto gap-6 mt-6 mt-10 mb-8'>
        ...
        bg-white mb-6 dark:bg-darkHover/30 dark:border-white/90' name='message'></motion.textarea>
        ...
        > Submit now<Image src={assets.right_arrow_white} className='w-4' alt='' />
        </motion.button>
