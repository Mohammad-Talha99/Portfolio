    ...
    <>
      ...
      ${isScroll ? " backdrop-blur-sm shadow-sm dark:bg-darkTheme dark:bg-transparent  dark:shadow-white/20":""}`}>
        ...
        round-full px-12 py-3 ${isScroll ? "" : "bg-white rounded-full shadow-sm bg-opacity-50 dark:border dark:border-white/50 dark:bg-transparent cursor-pointer"} `}>
          <li className='hover:bg-lightHover hover:-translate-y-1 duration-500 cursor-pointer  px-3 py-1 rounded-md dark:hover:bg-darkHover '><a className='font-Ovo' href="#top">Home</a></li>
          <li className='hover:bg-lightHover hover:-translate-y-1 duration-500 cursor-pointer  px-3 py-1 rounded-md dark:hover:bg-darkHover '><a className='font-Ovo' href="#about">About me</a></li>
          <li className='hover:bg-lightHover hover:-translate-y-1 duration-500 cursor-pointer  px-3 py-1 rounded-md dark:hover:bg-darkHover '><a className='font-Ovo' href="#services">Services</a></li>
          <li className='hover:bg-lightHover hover:-translate-y-1 duration-500 cursor-pointer  px-3 py-1 rounded-md dark:hover:bg-darkHover '><a className='font-Ovo' href="#work">My Work</a></li>
          <li className='hover:bg-lightHover hover:-translate-y-1 duration-500 cursor-pointer  px-3 py-1 rounded-md dark:hover:bg-darkHover '><a className='font-Ovo' href="#contact">Contact me</a></li>
        </ul>
